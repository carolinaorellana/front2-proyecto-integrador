window.addEventListener('load', function () {
    ...
    /*VALIDAR INPUTS -CONTENIDO*/
    nombre.addEventListener("input", validarTexto)
    apellido.addEventListener("input", validarTexto)

    email.addEventListener("input", validarEmail)
    password.addEventListener("input", validarContrasenia)
    passwordRepetida.addEventListener("input", e => compararContrasenias(password, passwordRepetida, e))

    //VALIDAR INPUTS - VACIO
    ...
    passwordRepetida.addEventListener("blur", e => isEmpty(`Se requiere que ingrese su ${passwordRepetida.name}`, e))
